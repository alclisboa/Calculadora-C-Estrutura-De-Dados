...
int main() {
    ...
    const char *expressao7 = "10 3 ^ l 2 +";
    ...
    const char *expressao10 = "3 4 + 5 t *";
    double resultado10 = avaliarExpressaoPosfixada(expressao10);
    printf("Teste 10, Resultado: Aprox. %.2lf\n", resultado10);
    traduzirParaPrefixada(expressao10);
